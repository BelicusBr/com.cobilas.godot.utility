...
namespace Godot;
/// <summary>
/// Provides extension methods for Godot's <seealso cref="TextEdit"/> class, allowing string operations to be performed fluently and efficiently using <seealso cref="StringBuilder"/> internally.
/// </summary>
/// <remarks>
...
public static class TextEdit_CB_GD_Extension {
    ...
    /// <summary>
    /// Adds a character repeated a specified number of times to the text of <seealso cref="TextEdit"/>.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    /// <param name="value">Character to be added</param>
    /// <param name="repeatCount">Number of repetitions of the character</param>
    /// <returns>The <seealso cref="TextEdit"/> itself to allow chained calls</returns>
    /// <exception cref="ArgumentNullException">Thrown when <seealso cref="TextEdit"/> is null</exception>
    ...
    /// <summary>
    /// Adds the <seealso cref="string"/> representation of a <seealso cref="bool"/> value to the <seealso cref="TextEdit"/> text.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    ...
    /// <summary>
    /// Adds a character to the <seealso cref="TextEdit"/> text.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    /// <param name="value">Character to be added</param>
    /// <returns>The <seealso cref="TextEdit"/> itself to allow chained calls</returns>
    ...
    /// <summary>
    /// Adds a <seealso cref="ulong"/> value to the <seealso cref="TextEdit"/> text.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    ...
    /// <summary>
    /// Adds a <seealso cref="uint"/> value to the <seealso cref="TextEdit"/> text.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    ...
    /// <summary>
    /// Adds a <seealso cref="byte"/> value to the <seealso cref="TextEdit"/> text.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    ...
    /// <summary>
    /// Adds a substring to the <seealso cref="TextEdit"/> text.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    ...
    /// <summary>
    /// Adds a <seealso cref="string"/> to the text of the <seealso cref="TextEdit"/>.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    ...
    /// <summary>
    /// Adds a <seealso cref="float"/> value to the text of the <seealso cref="TextEdit"/>.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    ...
    /// <summary>
    /// Adds a <seealso cref="ushort"/> value to the text of the <seealso cref="TextEdit"/>.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    ...
    /// <summary>
    /// Adds the <seealso cref="string"/> representation of a <seealso cref="object"/> to the text of the <seealso cref="TextEdit"/>.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    ...
    /// <summary>
    /// Adds a <seealso cref="T:char[]"/> to the text of the <seealso cref="TextEdit"/>.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    ...
    /// <summary>
    /// Adds a part of a <seealso cref="T:char[]"/> to the text of the <seealso cref="TextEdit"/>.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    ...
    /// <summary>
    /// Adds a <seealso cref="sbyte"/> value to the text of <seealso cref="TextEdit"/>.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    ...
    /// <summary>
    /// Adds a <seealso cref="decimal"/> value to the text of <seealso cref="TextEdit"/>.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    ...
    /// <summary>
    /// Adds a <seealso cref="short"/> value to the text of <seealso cref="TextEdit"/>.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    ...
    /// <summary>
    /// Adds a <seealso cref="int"/> value to the text of <seealso cref="TextEdit"/>.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    ...
    /// <summary>
    /// Adds a <seealso cref="long"/> value to the text of <seealso cref="TextEdit"/>.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    ...
    /// <summary>
    /// Adds a <seealso cref="double"/> value to the text of <seealso cref="TextEdit"/>.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    ...
    /// <summary>
    /// Adds a line break to the text of <seealso cref="TextEdit"/>.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    /// <returns>The <seealso cref="TextEdit"/> itself to allow chained calls</returns>
    /// <exception cref="ArgumentNullException">Thrown when <seealso cref="TextEdit"/> is null</exception>
    ...
    /// <summary>
    /// Adds a <seealso cref="string"/> followed by a line break to the text of the <seealso cref="TextEdit"/>.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    /// <param name="value"><seealso cref="string"/> to be added</param>
    /// <returns>The <seealso cref="TextEdit"/> itself to allow chained calls</returns>
    ...
    /// <summary>
    /// Adds the <seealso cref="string"/> representation of a <seealso cref="object"/> followed by a line break to the text of the <seealso cref="TextEdit"/>.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    /// <param name="value"><seealso cref="object"/> to be added</param>
    /// <returns>The <seealso cref="TextEdit"/> itself to allow chained calls</returns>
    ...
    /// <summary>
    /// Inserts a portion of a <seealso cref="T:char[]"/> into the text of the <seealso cref="TextEdit"/> at the specified position.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    ...
    /// <summary>
    /// Inserts the <seealso cref="string"/> representation of a <seealso cref="bool"/> value into the text of the <seealso cref="TextEdit"/> at the specified position.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    /// <param name="index">Position where to insert</param>
    ...
    /// <summary>
    /// Inserts the <seealso cref="string"/> representation of a <seealso cref="byte"/> value into the text of the <seealso cref="TextEdit"/> at the specified position.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    /// <param name="index">Position where to insert</param>
    ...
    /// <summary>
    /// Inserts the <seealso cref="string"/> representation of a <seealso cref="ulong"/> value into the text of the <seealso cref="TextEdit"/> at the specified position.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    /// <param name="index">Position where to insert</param>
    ...
    /// <summary>
    /// Inserts a <seealso cref="T:char[]"/> into the text of the <seealso cref="TextEdit"/> at the specified position.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    /// <param name="index">Position where to insert</param>
    ...
    /// <summary>
    /// Inserts the <seealso cref="string"/> representation of a <seealso cref="ushort"/> value into the text of the <seealso cref="TextEdit"/> at the specified position.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    /// <param name="index">Position where to insert</param>
    ...
    /// <summary>
    /// Inserts a <seealso cref="string"/> repeated a specified number of times into the text of the <seealso cref="TextEdit"/> at the specified position.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    /// <param name="index">Position where to insert</param>
    ...
    /// <summary>
    /// Inserts a <seealso cref="char"/> into the text of the <seealso cref="TextEdit"/> at the specified position.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    /// <param name="index">Position where to insert</param>
    ...
    /// <summary>
    /// Inserts the <seealso cref="string"/> representation of a <seealso cref="uint"/> value into the text of the <seealso cref="TextEdit"/> at the specified position.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    /// <param name="index">Position where to insert</param>
    ...
    /// <summary>
    /// Inserts the <seealso cref="string"/> representation of a <seealso cref="sbyte"/> value into the text of the <seealso cref="TextEdit"/> at the specified position.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    /// <param name="index">Position where to insert</param>
    ...
    /// <summary>
    /// Insere a representação em <seealso cref="string"/> de um <seealso cref="object"/> no texto do <seealso cref="TextEdit"/> na posição especificada.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    /// <param name="index">Position where to insert</param>
    ...
    /// <summary>
    /// Inserts the <seealso cref="string"/> representation of a <seealso cref="long"/> value into the text of the <seealso cref="TextEdit"/> at the specified position.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    /// <param name="index">Position where to insert</param>
    ...
    /// <summary>
    /// Inserts the <seealso cref="string"/> representation of a <seealso cref="int"/> value into the text of the <seealso cref="TextEdit"/> at the specified position.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    /// <param name="index">Position where to insert</param>
    ...
    /// <summary>
    /// Inserts the <seealso cref="string"/> representation of a <seealso cref="short"/> value into the text of the <seealso cref="TextEdit"/> at the specified position.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    /// <param name="index">Position where to insert</param>
    ...
    /// <summary>
    /// Inserts the <seealso cref="string"/> representation of a <seealso cref="double"/> value into the text of the <seealso cref="TextEdit"/> at the specified position.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    /// <param name="index">Position where to insert</param>
    ...
    /// <summary>
    /// Inserts the <seealso cref="string"/> representation of a <seealso cref="decimal"/> value into the text of the <seealso cref="TextEdit"/> at the specified position.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    /// <param name="index">Position where to insert</param>
    ...
    /// <summary>
    /// Inserts the <seealso cref="string"/> representation of a <seealso cref="float"/> value into the text of the <seealso cref="TextEdit"/> at the specified position.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    /// <param name="index">Position where to insert</param>
    ...
    /// <summary>
    /// Inserts a <seealso cref="string"/> into the text of the <seealso cref="TextEdit"/> at the specified position.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    /// <param name="index">Position where to insert</param>
    /// <param name="value"><seealso cref="string"/> value to be inserted</param>
    ...
    /// <summary>
    /// Replaces all occurrences of one <seealso cref="char"/> with another in the text of the <seealso cref="TextEdit"/>.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    ...
    /// <summary>
    /// Replaces all occurrences of one <seealso cref="char"/> with another in a specified portion of the text of the <seealso cref="TextEdit"/>.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    /// <param name="oldChar"><seealso cref="char"/> to be replaced</param>
    /// <param name="newChar">Replaced <seealso cref="char"/></param>
    ...
    /// <summary>
    /// Replaces all occurrences of one <seealso cref="string"/> with another in the text of the <seealso cref="TextEdit"/>.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    ...
    /// <summary>
    /// Replaces all occurrences of one <seealso cref="string"/> with another in a specified portion of the text of the <seealso cref="TextEdit"/>.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    /// <param name="oldValue"><seealso cref="string"/> to be replaced</param>
    /// <param name="newValue">Replaced <seealso cref="string"/></param>
    ...
    /// <summary>
    /// Clears all text from <seealso cref="TextEdit"/>.
    /// </summary>
    /// <param name="L"><seealso cref="TextEdit"/> target (can be null)</param>
    /// <returns>The <seealso cref="TextEdit"/> itself to allow chained calls</returns>
    /// <exception cref="ArgumentNullException">Thrown when <seealso cref="TextEdit"/> is null</exception>
