...
public static class Rect2_GD_CB_Extension {
    ...
    /// <summary>Get the width of the <see cref="Godot.Rect2"/></summary>
    /// <param name="R">That will be used.</param>
    /// <returns>Returns a floating-point right width of <see cref="Godot.Rect2"/>.</returns>
    public static float Width(this Rect2 R) => R.Size.x;
    /// <summary>Get the height of the <see cref="Godot.Rect2"/></summary>
    /// <param name="R">That will be used.</param>
    /// <returns>Returns a floating-point right height of <see cref="Godot.Rect2"/>.</returns>
    public static float Height(this Rect2 R) => R.Size.y;
